package com.sk.recipe.bootstrap;
...
import com.sk.recipe.domain.Difficulty;
import com.sk.recipe.domain.Ingredient;
import com.sk.recipe.domain.Notes;
...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent>{
	...
	private List<Recipe> getRecipes(){
        ...
        Optional<Category> americanCategoryOptional = categoryRepository.findByDecription("American");

        if(!americanCategoryOptional.isPresent()){
            throw new RuntimeException("Expected Category Not Found");
        }

        Optional<Category> mexicanCategoryOptional = categoryRepository.findByDecription("Mexican");
